...
insert into employees(Firstname,LastName,DepartmentId,Salary,DateOfJoining,email)
values
('Sidharth','Gupta',3,70000,"2024-01-01","siddharth.gupta@example.com"),
...
VALUES (11, 'Marketing', 1300000.00, 'Pune', 'Rakesh Mehta');
...
INSERT INTO EMPLOYEES(FirstName,LastName,Salary,DateOfJoining,Email,DepartmentId) values
('Rahul','Mehra',58000,"2024-01-10","rahul.mehra@example.com",11),
('Sara','Kapoor',62000,"2024-01-11","sara.kapoor@example.com",11),
('Nitin','Shah',60000,"2024-01-12","nitin.shah@example.com",11);
...
INSERT INTO EMPLOYEES(FirstName,LastName,Salary,DateOfJoining,Email,DepartmentId) VALUES
("Riya","Sharma","50000",'2024-02-01',"Riya.sharma@example.com",1),
("Mohit","Desai","55000",'2024-02-02',"Mohit.desai@example.com",1);
...
INSERT INTO EMPLOYEES(FirstName,LastName,Salary,DateOfJoining,Email,DepartmentId) VALUES
("Sneha","Rao","50000",'2024-02-15',"Sneha.rao@example.com",2);
...
INSERT INTO EMPLOYEES(FirstName,LastName,Salary,DateOfJoining,Email,DepartmentId) VALUES
("Aditya","Malhotra","65000",'2024-03-01',"Aditya.malhotra@example.com",7),
("Priyanka","Kapoor","67000",'2024-03-02',"priyanka.kapoor@example.com",7),
("Kunal","Singh","68000",'2024-03-03',"kunal.singh@example.com",7);
...
insert into departments(DepartmentId,AnnualBudget,Location,HeadOfDepartment,DepartmentName) values
(12,2000000,"Hydrabad","Dr. MEERA JOSHI","Research");
...
insert into employees(Firstname,lastname,salary,dateofjoining,departmentid,email)
values
('Arjun','Shah','75000','2024-04-01','12','arjun.shah@example.com'),
('Riya','Patel','72000','2024-04-02','12','riya.patel@example.com');
...
insert into departments(DepartmentId,AnnualBudget,Location,HeadOfDepartment,DepartmentName) values
(13,900000,"Chennai","Ravi Varma","Logistics");
...
insert into employees(Firstname,lastname,salary,dateofjoining,departmentid,email)
values
('Kavita','Desai','50000','2024-05-01','13','kavita.desai@example.com'),
('AMit','Jain','52000','2024-05-02','13','amit.jain@example.com');
...
select d.departmentname,sum(salary) as total from employees e
join departments d
...
select d.departmentname,count(employeeId) as count from employees e
join departments d
on e.DepartmentId=d.departmentid
...
select d.departmentname,avg(salary) as Avarage from employees e
join departments d
on e.DepartmentId=d.departmentid
group by d.departmentname;
...
select d.departmentname,min(DateOfJoining) as Early from employees e
join departments d
on e.DepartmentId=d.departmentid
group by d.departmentname;
...
select d.Departmentname,max(salary) as maximum from employees e 
join departments d 
on e.DepartmentId = d.departmentid
group by d.DepartmentName;
...
select d.Departmentname,min(salary) as minimum from employees e 
join departments d 
on e.DepartmentId = d.departmentid
group by d.DepartmentName;
...
select d.Departmentname,sum(e.salary) as total from employees e 
join departments d 
on e.DepartmentId = d.departmentid
...
SELECT
    LEFT(e.FirstName, 1) AS first_letter,
    COUNT(e.employeeID) AS count_of_employees
FROM
    employees e
GROUP BY
    first_letter
...
select firstname,concat(departmentId," ",employeeid) as unique_id from employees;
...
UPDATE Employees
SET Email = CONCAT(SUBSTRING(Email,1,INSTR(Email, '@') - 1),'@newcompany.com')
...
delete from employees
where year(DateOfJoining)<'2020' and project is null;
...
delete from employees
where departmentname ="Marketing" and year(DateOfJoining) < "2022";
...
delete from employees
where region = "North" and year(EmployeeEnd) < "2023";
...
alter table employees
add column DepartmentName varchar(20);
...
-- integrity and consistency across both table
